...
public class AuthorizationFlowPublishingInterceptorTest {
    ...
    private AuthorizationFlowPublishingInterceptor interceptor;
    ...
    public void beforeEach() throws IOException {
        ...
        interceptor = new AuthorizationFlowPublishingInterceptor(PROVIDER, producerMock, clientToken);
    }

    @Test
    public void shouldNotPublishDataForNonAuthorizationFlowRequest() throws IOException {
        // given
    ...
    public void shouldPassProviderAndMethodOverWhenTheyArePresent() throws IOException {
        ...
        HttpRequest requestSpy = spy(HttpRequest.class);
        when(requestSpy.getMethod()).thenReturn(HttpMethod.POST);
        ...
        // then
        verify(producerMock).sendDataAsync(RawDataSource.AUTHORIZATION_FLOW, "{}", PROVIDER, clientToken, "POST", DEFAULT_URI.toString());
        verifyNoMoreInteractions(producerMock);
    }
    ...
    public void shouldPassUnknownOverWhenProviderAndMethodAreAbsent() throws IOException {
        ...
        // then
        verify(producerMock).sendDataAsync(RawDataSource.AUTHORIZATION_FLOW, "{}", PROVIDER, clientToken, "UNKNOWN", DEFAULT_URI.toString());
        verifyNoMoreInteractions(producerMock);
    }
